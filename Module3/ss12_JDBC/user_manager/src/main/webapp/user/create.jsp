        ...
        <form method="post" class="form-control-edit">
            <table class="table table-striped bg-light">
                ...
                <tr>
                    <th>User Name:</th>
                    <td>
                        <input type="text" name="name" required class="input-info"
                ...
                <tr>
                    <th>User Email:</th>
                    <td>
                        <input type="text" name="email" required class="input-info"
                ...
                <tr>
                    <th>Country:</th>
                    <td>
                        <input type="text" name="country" required class="input-info"
